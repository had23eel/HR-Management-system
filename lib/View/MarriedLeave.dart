import 'package:employeee/Controller/MarriedController.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
class UnjustLeave extends StatefulWidget {
  const UnjustLeave({Key? key}) : super(key: key);

  @override
  State<UnjustLeave> createState() => _UnjustLeaveState();
}

class _UnjustLeaveState extends State<UnjustLeave> {
  _ontap(){

      print("send to api");

      MarriedController marriedController = MarriedController();
      marriedController.MarriedLeaveConteroller(Sdate!, Edate!);
