import 'package:employeee/Controller/AdminLeaveController.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
class AdministratorLeave extends StatefulWidget {
  const AdministratorLeave({Key? key}) : super(key: key);

  @override
  State<AdministratorLeave> createState() => _AdministratorLeaveState();
}

class _AdministratorLeaveState extends State<AdministratorLeave> {
...
_onTap(){
  if(_formfield.currentState!.validate())
  {
    ...
    AdminLeaveConteroller adminLeaveController = AdminLeaveConteroller();
    adminLeaveController.adminLeaveConteroller(Sdate!, Edate!);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Administrator Leave'),
        centerTitle: true,
      ),
