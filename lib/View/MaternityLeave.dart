import 'package:employeee/Controller/MaternityLeaveController.dart';
...
class _MaternityLeaveState extends State<MaternityLeave> {
  ...
  DateTime _dateTimeE = DateTime.now().add(new Duration(days: 90));
  String? Sdate,Edate;
  _ontap(){
    MaternityLeaveConteroller mcont = MaternityLeaveConteroller();
    mcont.maternityLeaveConteroller(Sdate, Edate);
  }
  void _showDatePicker(){
    showDatePicker(
      ...
      setState(() {
        _dateTime = value!;
        _dateTimeE = _dateTime.add(Duration(days: 90));
