import 'package:employeee/Controller/ChristianPilgrimageLeaveController.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
class ChristianPilgrimageLeave extends StatefulWidget {
  const ChristianPilgrimageLeave({Key? key}) : super(key: key);

  @override
  State<ChristianPilgrimageLeave> createState() => _ChristianPilgrimageLeaveState();
}

class _ChristianPilgrimageLeaveState extends State<ChristianPilgrimageLeave> {
  DateTime _dateTime = DateTime.now();
  DateTime _dateTimeE = DateTime.now().add(new Duration(days: 7));
  String? Sdate,Edate;
  _ontap(){
    ChristianPilgrimageLeaveConteroller cpcont = ChristianPilgrimageLeaveConteroller();
    cpcont.christianPilgrimageLeaveConteroller(Sdate, Edate);
  }
  void _showDatePicker(){
    showDatePicker(
      ...
      setState(() {
        _dateTime = value!;
        _dateTimeE = _dateTime.add(Duration(days: 7));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Christian Pilgrimage Leave'),
        centerTitle: true,
      ),
      body: Column(
