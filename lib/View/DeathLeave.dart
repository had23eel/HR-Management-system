import 'package:employeee/Controller/DeathLeaveController.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
class DeathLeave extends StatefulWidget {
  const DeathLeave({Key? key}) : super(key: key);
...
class _DeathLeaveState extends State<DeathLeave> {
  ...
  String? Sdate, Edate;
  _ontap(){
    DeathLeaveConteroller dcont = DeathLeaveConteroller();
    dcont.deathLeaveConteroller(Sdate, Edate);
  }
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          SizedBox(height: 25,),
          const Center(child: Text('We are very sorry for your lost',style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),)),
